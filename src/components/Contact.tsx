...
export default function Contact() {
  ...
  return (
    <section>
      <h2 className='contact-text font-bold text-3xl mb-3 lg:mb-[2rem] lg:text-4xl'>get in touch</h2>
      ...
      <a href="mailto:sariahkjackson@gmail.com">
        <ShineBorder className="font-plus mt-5 font-bold -z-1 relative bg-offWhite text-grey" color='grey'>
          Say hi
        </ShineBorder>
      </a>
    </section>
